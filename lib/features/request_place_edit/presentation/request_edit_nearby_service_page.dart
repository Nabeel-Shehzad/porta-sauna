...
import 'package:portasauna/features/request_place_edit/presentation/request_edit_nearby_activity_page.dart';

class RequestEditNearbyServicePage extends StatelessWidget {
  const RequestEditNearbyServicePage({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                ListView.builder(
                  ...
                  itemCount: rec.nearbyServicesList.length,
                  itemBuilder: (context, i) {
                    return CustomCheckbox(
                        onChanged: (v) {
                          rec.setSelectedNearbyService(i);
                        },
                        isChecked: rec.nearbyServicesList[i].selected,
                        text: rec.nearbyServicesList[i].name);
                  },
                ),
                ButtonPrimary(
                    ...
                    text: 'Next',
                    onPressed: () {
                      Get.to(const RequestEditNearbyActivityPage());
                    }),
                gapH(45),
              ],
            ),
